...
class VueZoomImg {
    ...
    buildOptions(binding) {
        return Object.assign(Object.assign({}, this.defaultOptions), (typeof binding.value === 'object' ? binding.value : { src: binding.value }));
    }
    get allInstances() {
    ...
    closePreview() {
        ...
        const instance = document.querySelector('.maz-zoom-img-instance.maz-is-open');
        if (instance)
            instance.classList.remove('maz-is-open');
        if (container)
    ...
    nextPreviousImage(isNext) {
        ...
        const currentInstance = document.querySelector('.maz-zoom-img-instance.maz-is-open');
