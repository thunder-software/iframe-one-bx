    ...
    <tbody :class="fontSize(displaytable.fontSize)">
      <tr>
          ...
          <td
            ...
            <!-- 'hidden' : hiddenRow(data.odds , 'FH_Handicap' ,i) -->
            <tr v-for="(data, i) in getData" :key="i" v-if="data.priceRow != 0 && data.collapse != 'open'" :class="{'odd' :data.count_match % 2 == 0 , 'hidden' : hiddenRow(data.odds , 'FH_Handicap' ,i) == '1'}">
            <td class="align-center w-12" colspan="2" style="height: 36px">
              ...
              <td class="align-center" >
                ...
                <small class="font-semibold pl-0" @click="ticket(data, 'teamhome')" :title="transname(data.home_th, data.home_en)">
                  {{ _keyLang == '_th' ? data.home_th : data.home_en  }} (1st)
                </small>
              ...
              <span class="text-left cursor-pointer block ml-2"
                ...
                <small class="font-semibold pl-0" @click="ticket(data, 'teamaway')" :title="transname(data.away_th, data.away_en)">
                  {{ _keyLang == '_th' ? data.away_th : data.away_en  }} (1st)
                </small>
                <b-img  v-for="(card, i) in data.away_red_cards" :key="i" src="/icon/redcard.gif" class="inline-block" />
              </span>
              </td>
            <td class="w-12" is="center2-column2-point2" :odds="data.odds" :marketType="'FH_Handicap'" :isonline="data.row_is_online"></td>
  
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_Handicap'" :index="i" :type="'h'" :isonline="data.row_is_online"></td>
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_Handicap'" :index="i" :type="'a'" :isonline="data.row_is_online"></td>
  
            <td class="w-12" is="center2-column2-point2" :odds="data.odds" :marketType="'FH_OverUnder'" :isonline="data.row_is_online"></td>
            
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_OverUnder'" :index="i" :type="'h'" :isonline="data.row_is_online"></td>
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_OverUnder'" :index="i" :type="'a'" :isonline="data.row_is_online"></td>

            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'h'" :isonline="data.row_is_online"></td> 
            <!-- <td class="w-12" is="center2-column-betprice" :odds="data.odds" :marketType="'1x2'" :type="'h'"></td> -->
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'x'" :isonline="data.row_is_online"></td>
             <!-- <td class="w-12"></td> -->
            <!-- <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'1x2'" :index="i" :type="'a'" :isonline="data.row_is_online"></td> -->
             <!-- <td>{{ hiddenRow(data.odds , 'FH_Handicap' ,i) }}</td> -->
            <td class="w-12" is="center2-column2-price2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'a'" :isonline="data.row_is_online"></td>
              ...
              item.setting_w_b_l.forEach((setting, i) => {
                    ...
                    setting.sort_row = setting.sort_row
                      ...
                      let datas = {
                        ...
                        tournament_id : result[0].tournament.id,
