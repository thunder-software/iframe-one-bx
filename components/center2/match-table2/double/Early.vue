    ...
    <tbody :class="fontSize(displaytable.fontSize)">
      <tr>
          ...
          <td
            ...
            <!-- <td></td> -->
            <td class="align-center w-12" style="height: 36px" colspan="2">
            ...
            <td class="w-16 pt-1" is="center2-column2-point2" :odds="data.odds" :marketType="'Handicap'" :isonline="data.row_is_online" style="vertical-align: top;"></td>
  
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" :marketType="'Handicap'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" :marketType="'Handicap'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
            </td>
  
            <td class="w-16 pt-1" is="center2-column2-point2" :odds="data.odds" :marketType="'OverUnder'" :isonline="data.row_is_online" style="vertical-align: top;"></td>
  
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div :class="{'hidden' : hiddenRow(data.odds , 'OverUnder')}">
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.over")}}</small>
                        <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" class="flex-1 ml-2" :marketType="'OverUnder'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                    </div>
                    
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.under")}}</small>
                        <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" class="flex-1 ml-2" :marketType="'OverUnder'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
                    </div>
                </div>
            </td>
  
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div :class="{'hidden' : hiddenRow(data.odds , '1x2')}">
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">1</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'1x2'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                    </div>
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">2</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'1x2'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
                    </div>
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">X</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'1x2'" :index="i" :type="'x'" :isonline="data.row_is_online"></div>
                    </div>
                </div>
            </td>
  
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div :class="{'hidden' : hiddenRow(data.odds , 'OE')}">
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.odd")}}</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'OE'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                    </div>
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.even")}}</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'OE'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
                    </div>
                </div>
            </td>
            ...
            <td class="w-16 pt-1" is="center2-column2-point2" :odds="data.odds" :marketType="'FH_Handicap'" :isonline="data.row_is_online" style="vertical-align: top;"></td>
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" :marketType="'FH_Handicap'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" :marketType="'FH_Handicap'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
            </td>
  
            <td class="w-16 pt-1" is="center2-column2-point2" :odds="data.odds" :marketType="'FH_OverUnder'" :isonline="data.row_is_online" style="vertical-align: top;"></td>
  
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div :class="{'hidden' : hiddenRow(data.odds , 'FH_OverUnder')}">
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.over")}}</small>
                        <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" class="flex-1 ml-2" :marketType="'FH_OverUnder'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                    </div>
  
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">{{ trans("content.under")}}</small>
                        <div is="center2-column2-price-double" :odds="data.odds" :priceGroups="data" class="flex-1 ml-2" :marketType="'FH_OverUnder'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
                    </div>
                </div>
            </td>
            <td class="w-16 pt-1" style="vertical-align: top;">
                <div :class="{'hidden' : hiddenRow(data.odds , 'FH_1x2')}">
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">1</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'h'" :isonline="data.row_is_online"></div>
                    </div>
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">2</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'a'" :isonline="data.row_is_online"></div>
                    </div>
                    <div class="flex">
                        <small class="text-secondary font-semibold flex pl-1" style="font-size: 10px;">X</small>
                        <div is="center2-column2-price-double" class="flex-1 ml-2" :odds="data.odds" :priceGroups="data" :marketType="'FH_1x2'" :index="i" :type="'x'" :isonline="data.row_is_online"></div>
                    </div>
                </div>
            </td>
      </tr>
  ...
  export default {
    ...
    toggleFavorite(sport, event, isFavorite) {
      ...
      if (isEventFavorite) {
        ...
        hiddenRow(odds , market_type ,index){
  
        const value = odds.filter(d => d.market_type === market_type).find(d => d);
        if (value) {
            if (this.isonline == 1){
                var price = null;
                switch (this.type) {
