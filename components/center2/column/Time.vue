      ...
      <div>
        ...
        <div class="flex">
          <div class="flex" v-show="match.channel_live" style="cursor: pointer;" v-if="match.channel_live != undefined"
            ...
            <b-img src="/icon/layer1.jpg" class="inline-block pl-2 blink-image" style="margin-top: -4px;" />
          </div>
        ...
        <div class="flex">
          <div class="flex-1">
            ...
            <div v-show="match.channel_live" class="inline-block" style="cursor: pointer;"
                ...
                <b-img src="/icon/layer1.jpg" class="inline-block pr-1 blink-image" style="margin-top: -4px;" />
              </div>
