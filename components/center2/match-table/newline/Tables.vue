        ...
        <tr v-if="match.priceRow == 0 && match.setting_w_b_l[index][numbertpye] != 0 && match.collapse != 'open'"
          ...
          <td v-if="displaytable.lineType == 'SingleLine'">
            <div class="text-left pl-2">
              <div class="inline-block">
                <small class="block font-semibold" :class="namepath == 'muaythai-path' ? 'text-danger' : 'text-white'"> {{
                ...
                <small class="block font-semibold text-white"> {{ match['away' + _keyLang] ? match['away' + _keyLang] :
                  match['away_en']
          ...
          <td class="align-top" v-else>
            ...
            <div class="text-left pl-2">
              <div>
                <small class="inline-block font-semibold" :class="namepath == 'muaythai-path' ? 'text-danger' : 'text-white'"> {{
                  match['home' + _keyLang] ? match['home' + _keyLang] : match['home_en'] }} <b-img
                    v-for="(card, i) in match.home_red_cards" :key="i" src="/icon/redcard.gif"
                    class="inline-block" /></small>
              </div>
              <div>
                <small class="inline-block font-semibold text-white"> {{ match['away' + _keyLang] ? match['away' + _keyLang] :
        ...
        :class="{'odd' :match.count_match % 2 == 0}" v-if="match.collapse != 'open'">
          ...
          <td class="align-top" v-if="displaytable.lineType == 'DoubleLine'">
            ...
            <div class="text-left pl-2">
              <div class="inline-block">
                <div>
                  <small class="font-semibold" :class="checkType(match, index) == '1' ? 'text-danger' : 'text-white'">{{
                    match['home' + _keyLang] ? match['home' + _keyLang] : match['home_en'] }} <b-img
                      v-for="(card, i) in match.home_red_cards" :key="i" src="/icon/redcard.gif"
                      class="inline-block" /></small>
                </div>
                <div>
                  <small class="font-semibold" :class="checkType(match, index) == '2' ? 'text-danger' : 'text-white'">{{
                    match['away' + _keyLang] ? match['away' + _keyLang] : match['away_en'] }} <b-img
                      v-for="(card, i) in match.away_red_cards" :key="i" src="/icon/redcard.gif"
                      class="inline-block" /></small>
                </div>
...
export default {
  ...
  methods: {
    ...
    collapseData(){
      console.log('HHHHHHH',this.status);
      console.log('UUUUUUUU',this.type_nonlive);
